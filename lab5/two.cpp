...
{
        int last = a[n - 1];
        a[0] = a[last]; //eplacing last node with the root node
        n = n - 1;      //decreasing the size of the heap//
        heapify(n, 0);
}
void insert_element(int n) //we always insert the value from the last//
{
        int k;
        printf("Insert an element\n");
        scanf("%d", &k); //element to be inserted//
        n = n - 1;
        a[n - 1] = k;
        heapify(n, n - 1);
}
void replace_element(int n)
{
        int k, pos;
        printf("Enter an element to replace\n");
        scanf("%d", &k);
...
int main()
{
        ...
        while (1)
        {
                ...
                case 10:
                        printf("Inserint element in a node\n");
                        insert_element(n);
                        display(n);
                        break;
                case 11:
                        ...
                        break;
                case 12:
                        printf("Replace an element and then heapify\n");
                        replace_element(n);
                        display(n);
                        break;
                default:

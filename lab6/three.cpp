...
{
  cout << "\nMENU :";
  cout << "\nPress 1 Input n unique characters with their frequencies into an array.";
  cout << "\nPress 2 Display the Array";
  cout << "\nPress 3 Generate Huffman Tree and Traverse the tree with pre-order.";
  cout << "\nPress 4 Generate Huffman Codes for n charachers and display the same.";
  cout << "\nPress 5 to Compare Huffman code with Fixed-Length Code";
  cout << "\nPress 0 to Exit \n";
}
